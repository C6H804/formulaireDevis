...
<div class="section sectionSondage">
    ...
    <div class="inputField"><input type="checkbox" class="chkSondage" name="chkSondageRouteLescar"
            ...
            Lescar</label></div>
    <div class="inputField"><input type="checkbox" class="chkSondage" name="chkSondageAutre"
            id="chkSondageAutre" value="on"></input><label for="chkSondageAutre">Autre</label></div>
</div>
...
<div class="section sectionCGU">
    <div class="inputField">
        ...
        <label for="chkAcceptCGU">En
            soumettant ce formulaire, j'accepte que les informations saisies soient exploitées dans le cadre de la demande
